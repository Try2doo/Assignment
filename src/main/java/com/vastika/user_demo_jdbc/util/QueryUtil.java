...
public class QueryUtil {
	...
	public static final String INSERT_SQL = "insert into user_tbl(user_name,password,address,phone_no)values(?,?,?,?)";

	public static final String UPDATE_SQL = "update user_tbl user_name=?,password=?,address=?,mobile_no=? where id=?";
